...
export default function LayoutProvider({ children }) {
    ...
    return (
        <div className="app-shell h-[100dvh] min-h-[100dvh] w-full overflow-hidden bg-gray-100 dark:bg-gray-950 flex justify-center transition-colors duration-300">
            <div className={`w-full ${maxWidth} h-full min-h-0 min-w-0 relative flex flex-col shadow-xl overflow-hidden`}>
                {children}
            </div>
        </div>
    );
