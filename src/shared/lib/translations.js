export const TRANSLATIONS = {
    en: {
        ...
        tile_visualNavigator: 'Visual Navigator',
        tile_visualNavigator_desc: 'Real-time camera and voice navigation helper.',
    ...
    ml: {
        ...
        tile_visualNavigator: 'വിഷ്വൽ നാവിഗേറ്റർ',
        tile_visualNavigator_desc: 'തത്സമയ ക്യാമറ, വോയ്‌സ് നാവിഗേഷൻ സഹായി.',
