...
export const TILE_REGISTRY = {
    ...
    textSimplifier: { label: 'Text Simplifier', icon: Type, path: '/reading-mode', color: 'bg-primary' },
    readAloud: { label: 'Read Aloud', icon: Volume2, path: '/reading-mode', color: 'bg-primary' },
    dyslexiaFont: { label: 'Dyslexia Font', icon: Type, path: '/profile', color: 'bg-primary' },
    spellCheck: { label: 'Spell Check', icon: FileText, path: '/reading-mode', color: 'bg-primary' },
    ...
    highContrast: { label: 'High Contrast', icon: Eye, path: '/profile', color: 'bg-primary' },
    textReader: { label: 'Text Reader', icon: Volume2, path: '/vision-assistant', color: 'bg-primary' },
    largeKeyboard: { label: 'Large Keyboard', icon: Type, path: '/profile', color: 'bg-primary' },
    colorInverter: { label: 'Color Inverter', icon: Settings2, path: '/profile', color: 'bg-primary' },
